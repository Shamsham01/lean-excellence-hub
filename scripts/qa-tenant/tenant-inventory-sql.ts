...
function buildInventorySql(organisationCode: string) {
...
export type TenantInventorySqlPayload = {
...
function parseInventoryPayload(
  ...
  const payload = inventory as TenantInventorySqlPayload;
...
export function collectTenantInventoryViaSql(
  databaseUrl: string,
