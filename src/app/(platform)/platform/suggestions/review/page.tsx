...
export default async function SuggestionReviewQueuePage({
  ...
  const items =
    ((queue as { items?: unknown[] })?.items as Array<
  ...
  return (
    <div className="flex flex-col gap-6" data-testid="suggestion-review-queue">
      <PageHeader
        ...
        description="Ideas in your review jurisdiction."
      />
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      ...
                      {item.origin_unit_name as string}
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <Link
                        href={`/platform/suggestions/review?suggestionId=${item.id as string}`}
                      >
                        Review
                      </Link>
                    </Button>
          ...
          <ReviewWorkspace
            suggestion={{
              ...
              problem_or_opportunity:
                (selected.problem_or_opportunity as string | null) ?? null,

              proposed_idea: (selected.proposed_idea as string | null) ?? null,

              category_name:
                (selected.category_name as string | null) ??
                (selected.category_name_snapshot as string | null) ??
                null,

              origin_unit_name:
                (selected.origin_unit_name as string | null) ??
