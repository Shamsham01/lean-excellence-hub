  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    setCredentials({
      ...
      ...(result.temporaryPassword
        ...
        : {}),
      ...(result.credentialsRecovered ? { credentialsRecovered: true } : {}),
    });
  }
    ...
    return (
      <div className="space-y-4" data-testid="workforce-credentials-panel">
        <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-sm text-amber-950">
          ...
          {credentials.credentialsRecovered ? (
            <p className="mt-2">
              Provisioning completed after a retry. Issue a credential reset if
              the employee still needs a new temporary password.
            </p>
          ) : null}
        </div>
