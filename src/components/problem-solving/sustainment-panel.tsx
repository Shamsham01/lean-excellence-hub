...
export function SustainmentPanel({
  ...
  return (
    <div
      ...
      data-testid="problem-solving-sustainment-panel"
    >
      {canManage ? (
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleCreate} className="flex flex-col gap-3">
              ...
              <Button
                ...
                size="sm"
                disabled={loading}
                data-testid="create-sustainment-item"
              >
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            Sustainment items ({detail.sustainment_items.length})
          </CardTitle>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            Lessons learned ({detail.lessons_learned.length})
          </CardTitle>
        </CardHeader>
        <CardContent className="flex flex-col gap-2 text-sm">
