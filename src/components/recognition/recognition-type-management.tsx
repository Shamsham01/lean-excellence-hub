...
export function RecognitionTypeManagement({ types }: RecognitionTypeManagementProps) {
  ...
  return (
    ...
    <div className="flex flex-col gap-8" data-testid="recognition-type-management">
