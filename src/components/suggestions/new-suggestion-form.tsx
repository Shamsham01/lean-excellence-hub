...
export function NewSuggestionForm({
  ...
  const [programmeVersionId, setProgrammeVersionId] = useState(programmeVersions[0]?.id ?? "");
      ...
      <CardContent>
        ...
        {!canSubmit ? (
          ...
          <p className="mb-4 text-sm text-muted-foreground">
            ...
            No published programmes or categories are available yet. Ask a programme

            manager to configure suggestion programmes before submitting ideas.
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <Button type="submit" disabled={loading || !canSubmit} className="min-h-11">
