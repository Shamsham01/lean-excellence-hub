...
export function ProgrammeManagement({
  ...
  const versionsByProgramme = programmes.reduce<Record<string, ProgrammeVersion[]>>(
  ...
  async function runAction(action: () => Promise<{ error?: string; ok?: true }>) {
    ...
    <div className="flex flex-col gap-8" data-testid="programme-management">
          ...
          >
            ...
            <label className="flex flex-col gap-1 text-sm">
              ...
              <Textarea
                ...
                onChange={(event) => setProgrammeDescription(event.target.value)}
      ...
      <div className="grid gap-4">
        ...
        {programmes.map((programme) => {
          ...
          const draftVersion = programmeVersions.find((version) => version.lifecycle === "draft");
              ...
              <CardContent className="flex flex-col gap-4 text-sm text-muted-foreground">
                ...
                {draftVersion ? (
                  ...
                  <DraftVersionEditor
                    ...
                    onPublish={() =>
                      ...
                      runAction(() => publishSuggestionProgrammeVersion(draftVersion.id))
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        ...
                        runAction(() => createSuggestionProgrammeSuccessor(programme.id))
                ...
                {archivedVersions.length > 0 ? (
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">Archived versions</p>

                    <ul className="mt-1 flex flex-col gap-1">

                      {archivedVersions.map((version) => (

                        <li key={version.id}>Version {version.version_number}</li>
          ...
          <CardContent className="flex flex-col gap-2 text-sm">
            ...
            {categories.map((category) => (
              ...
              <div key={category.id} className="flex justify-between gap-4">
                ...
                <span className="text-muted-foreground capitalize">{category.status}</span>
    ...
    <div className="rounded-md border border-border p-4">
      ...
      <div className="flex flex-col gap-3">
        ...
        <label className="flex flex-col gap-1">
          ...
          <Label htmlFor={`review-target-${version.id}`}>Review SLA (days)</Label>
        ...
        <label className="flex flex-col gap-1">
          ...
          <Label htmlFor={`template-version-${version.id}`}>Template version</Label>
            ...
            {templateVersions.map((templateVersion) => {
              ...
              return (
                ...
                <option key={templateVersion.id} value={templateVersion.id}>
                  ...
                  {template?.display_name ?? "Template"} v{templateVersion.version_number}
        ...
        <label className="flex flex-col gap-1">
          ...
          <Label htmlFor={`submission-guidance-${version.id}`}>Submission guidance</Label>
          ...
          <Button
            ...
            onClick={() =>
              ...
              onSave({
                ...
                reviewTargetDays: reviewTargetDays ? Number(reviewTargetDays) : null,
