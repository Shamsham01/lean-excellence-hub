...
export function TabsList({
  ...
  return (
    <TabsPrimitive.List
      className={cn(
        "flex h-10 min-w-0 w-full max-w-full [scrollbar-width:none] items-center justify-start gap-1 overflow-x-auto rounded-lg border border-border bg-muted/40 p-1 [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden",
        className,
      )}
      {...props}
    />
